        ...
        void ParseStaticinfo(SSParser _parser)
        {
            ...
            while (_parser.next())
            {
                ...
                if (!dic_ItemInfoBase.ContainsKey(_itemcode))
                {
                    ...
                    Debug.Log(_staticinfo.ToString());
                }
            }
        }
        ...
        void ParseLevelupreward(SSParser _parser)
        {
            ...
            while (_parser.next())
            {
                ...
                if (!dic_ItemInfoBase.ContainsKey(_itemcode))
                {
                    ...
                    Debug.Log(_livelupreward.ToString());
                }
            }
        }
